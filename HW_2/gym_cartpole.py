...
class Network:
    ...
    def construct(self, args):
        with self.session.graph.as_default():
            ...
            hidden_layer = tf.layers.dense(self.observations, units=4, activation=tf.nn.tanh, name="hidden_layer")
            output_layer = tf.layers.dense(hidden_layer, units=self.ACTIONS, activation=None, name="output_layer")
